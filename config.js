...
SESSION_ID: process.env.SESSION_ID || "HdgynARb#Q3S537B3a-ubA0W2DgCEfieO_xZf4NihFW0CDqEDLvQ",  // ADD Your Session Id 
...
ANTI_BAD: process.env.ANTI_BAD || "false", //add true or false
FAKE_RECORDING: process.env.FAKE_RECORDING || "true", //add true or false
AUTO_REACT: process.env.AUTO_REACT || "false", //add true or false
...
ALIVE_MSG: process.env.ALIVE_MSG || "Hello", //add alive msg
};
